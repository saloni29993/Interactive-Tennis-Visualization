...
var xScale = d3.scale.linear().domain([180, 230]).range([0, width - yearMargin]),
    yScale = d3.scale.linear().domain([80, 160]).range([height, 0]),
    radiusScale = d3.scale.linear().domain([4, 20]).range([7, 25]),
