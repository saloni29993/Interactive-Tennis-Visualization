...
d3.csv("data.csv", row, function(error, csv_data){
    ...
    data_svg.append("text")      // text label for the x axis
            .attr("transform", "translate(780,590)")
    ...
    var radiusScale = d3.scale.linear().domain([0, 20]).range([10, 40]);
    ...
    var data_circles = data_g.append("circle")
        ...
        .on("mouseover", function(d) {
            ...
            div .html("Fast Serve Speed: " + d.fastserve + "<br/> Ace Score: "  + d.aces + "<br/> Year: "  + d.year) 
